...
class WeatherInfoThread(QThread):
    ...
    def weatherInfoOutput(self, weather_area):
        ...
        try:
            ...
            weather_info.append([area_text]+[today_temper]+[today_weather]+[yesterday_weather]+[sense_temper_text]+[dust1_info]+[dust2_info])
            ...
            try:
                ...
                print(area_text)
                today_temper = weather_soup.find('span', {'class': 'todaytemp'}).text  # 현재 온도
                print(today_temper)
...
class WeatherAppWindow(QMainWindow, form_class):
    def __init__(self):
        ...
        self.setWindowFlags(Qt.WindowStaysOnTopHint)  # 윈도우 항상 위
    ...
    def crawling_weather(self):
        ...
        if weather_result == 0:
            ...
            self.setWeatherImage(weather_result[0][2])
            self.temper_label.setText(weather_result[0][1])
            self.yesterday_label.setText(weather_result[0][3])
            self.senseTemper_label.setText(weather_result[0][4])
